...
ActiveRecord::Schema.define(version: 2020_11_06_173845) do
  ...
  create_table "microposts", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "picture", collation: "latin1_swedish_ci"
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "remember_digest", collation: "latin1_swedish_ci"
    t.boolean "admin", default: false
    t.string "activation_digest", collation: "latin1_swedish_ci"
    t.boolean "activated", default: false
    t.datetime "activated_at"
    t.string "reset_digest", collation: "latin1_swedish_ci"
